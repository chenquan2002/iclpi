...
if __name__ == "__main__":
    ...
    robotwin_root = Path(__file__).resolve().parents[3]
    dataset_root = robotwin_root / "data_NAS" /"data"/ "dataset"
    ...
    target_dir = robotwin_root / "policy" / "pi05" / "processed_data" / f"{task_name}-{setting}-{expert_data_num}"
